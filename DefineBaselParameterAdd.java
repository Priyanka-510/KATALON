...
public class DefineBaselParameterAdd {
	...
	@Test
	public void testDefineBaselParameterAdd() throws Exception {
		...
		selenium.click("id=PC_MC_ddlCountryNameAdd");
		selenium.select("id=PC_MC_ddlCountryNameAdd", "label=GIFTCITY");
