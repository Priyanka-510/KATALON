...
public class DefineLLGGroupAdd {
	...
	@Test
	public void testDefineLLGGroupAdd() throws Exception {
		...
		selenium.open("http://localhost/BASELTEST_PL/BASEL/Custom/MCParam/LLGGrp/LLGGrpDefMakerInfo.aspx");
		selenium.click("id=txtLLGGrpID");
		selenium.click("id=txtLLGGrpID");
		selenium.type("id=txtLLGGrpID", "2612");
		selenium.click("id=txtLLGGrpName");
		selenium.type("id=txtLLGGrpName", "Test2612");
