...
public class DefineDimensionAdd {
	...
	@Test
	public void testDefineDimensionAdd() throws Exception {
		...
		selenium.click("id=PC_MC_AddEditUC_TCMain_TPNewData_txtRptDimName");
		selenium.type("id=PC_MC_AddEditUC_TCMain_TPNewData_txtRptDimName", "Test2612");
		selenium.click("id=PC_MC_AddEditUC_TCMain_TPNewData_rptEditdimItem_txtRptDimItemName_0");
		selenium.type("id=PC_MC_AddEditUC_TCMain_TPNewData_rptEditdimItem_txtRptDimItemName_0", "1 month");
		...
		selenium.type("id=PC_MC_AddEditUC_TCMain_TPNewData_rptEditdimItem_txtRptDimItemName_1", "2 month");
