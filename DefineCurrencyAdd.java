...
public class DefineCurrencyAdd {
	...
	@Test
	public void testDefineCurrencyAdd() throws Exception {
		...
		selenium.click("id=txtCurrency_ID");
		selenium.type("id=txtCurrency_ID", "RUP");
		selenium.click("id=txtCurrency_Description");
		selenium.type("id=txtCurrency_Description", "RUP");
		selenium.click("id=blnlstTRUEConsolidated");
		selenium.click("id=txtSource_ID");
		selenium.click("id=txtSource_ID");
		selenium.type("id=txtSource_ID", "RUP");
		selenium.click("id=ddlMapIDLCal");
		selenium.select("id=ddlMapIDLCal", "label=Holiday test");
