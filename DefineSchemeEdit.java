...
public class DefineSchemeEdit {
	...
	@Test
	public void testDefineSchemeEdit() throws Exception {
		...
		selenium.click("id=PC_MC_txtBktSchemeID");
		selenium.type("id=PC_MC_txtBktSchemeID", "Test3112");
		...
		selenium.click("id=lnkRptBtnAdd");
		selenium.click("id=ctl00_ctl00_PC_MC_AddEditUC_TCMain_TPNewData_rptEditBuckets_ctl02_txtBktDesc");
		selenium.type("id=ctl00_ctl00_PC_MC_AddEditUC_TCMain_TPNewData_rptEditBuckets_ctl02_txtBktDesc", "2 month");
		selenium.click("id=ctl00_ctl00_PC_MC_AddEditUC_TCMain_TPNewData_rptEditBuckets_ctl02_txtMatBktFrom");
		selenium.type("id=ctl00_ctl00_PC_MC_AddEditUC_TCMain_TPNewData_rptEditBuckets_ctl02_txtMatBktFrom", "2");
		selenium.click("id=ctl00_ctl00_PC_MC_AddEditUC_TCMain_TPNewData_rptEditBuckets_ctl02_txtMatBktTo");
		selenium.click("id=ctl00_ctl00_PC_MC_AddEditUC_TCMain_TPNewData_rptEditBuckets_ctl02_txtMatBktTo");
		selenium.type("id=ctl00_ctl00_PC_MC_AddEditUC_TCMain_TPNewData_rptEditBuckets_ctl02_txtMatBktTo", "2");
