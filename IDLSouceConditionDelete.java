...
public class IDLSouceConditionDelete {
	...
	@Test
	public void testIDLSouceConditionDelete() throws Exception {
		...
		selenium.click("id=PC_MC_txtConditionName");
		selenium.type("id=PC_MC_txtConditionName", "Test2612");
